...
<html>
	...
	<body>
			...
			<div class="container">
				...
				<nav id="nav">
					<ul>
						...
						<li class="active"><a id="meusCarros" href="CarrosAlugados.jsp">Meus Carros Alugados</a></li>
		...
		try (
			...
			PreparedStatement pst = connection.prepareStatement("select carroAno, linkImg from carrosAlugados where usuario = ?")){
			...
			ResultSet rs = pst.executeQuery();
				...
				<%i++; 
					...
					<section class="3u">
						...
						<a href="" class="image full"><img src="<%=rs.getString(2)%>" alt=""></a>

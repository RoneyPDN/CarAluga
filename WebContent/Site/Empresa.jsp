			...
			<div class="container">
				...
				<nav id="nav">
					<ul>
						...
						<li class="active"><a href="Empresa.jsp">Empresa</a></li>
		...
		if(usuario != "null" && !usuario.equals("admin")) {
		  ...
		  <%
			  ...
			  <script>
			  	...
			  	document.getElementById("carros2").style.display = "block";
			  	</script>
			  <%
		  }else {
			  %>
			...
			<div id="welcome" class="container">
				<div class="row ">
					<section>
						...
						<p>A Empresa CarAluga é nova no mercado, mas possuí qualidades como empenho, disciplina, códigos de conduta, valores e regras para atender da melhor forma possível seus clientes e garantir a satisfação do mesmo.</a>.</p>
						<p>Nos dias atuais, há diversas empresas de alocação de carros no Brasil, no entanto são poucas as que se comprometem a entregar carros averiguados e de qualidade para o cliente. Mesmo sendo nova no mercado, a empresa CarAluga busca atingir o desejo do cliente assim como qualquer outra empresa experiente na área, entregando carros averiguados semanalmente e fiscalizados dentro da lei e normas de cada estado.</p>
						<br>
						<p class="var"><strong>  Valores</strong></p>
						<ul class="estrela">
							<li>Atenção e Respeito com o Cliente</li>
							<li>Impactar a Experiência do Cliente de Forma Positiva</li>
							<li>Ser Referência no Mercado</li>
						</ul>
					</section>
				</div>
			</div>
